...
const Comment = ({comment}) => {
 ...
 return (
    <div className='bg-slate-500/5 text-gray-50 text-[14px] font-[500] mb-2 px-5 py-2 rounded-full shadow-md'>
        <div className='flexBetween gap-x-4'>
            <div className='text-[15px] font-[600] text-black'>{comment.authorUsername}</div>
